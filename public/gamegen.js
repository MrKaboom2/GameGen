// GameGen button injection (standalone plugin)
...
(function () {
  ...
  gamepadCSS.textContent = `
        ...
        .gamegen-button.active-focus,
        .gamegen-restart-button.active-focus {
  ...
  // ALL GameGen overlays that should block Steam navigation
  const OVERLAY_SELECTORS = [
    ".gamegen-overlay",
    ".gamegen-settings-overlay",
    ".gamegen-fixes-results-overlay",
    ".gamegen-loading-fixes-overlay",
    ".gamegen-unfix-overlay",
    ".gamegen-settings-manager-overlay",
    ".gamegen-alert-overlay",
    ".gamegen-confirm-overlay",
    ".gamegen-loadedapps-overlay",
  ];
  ...
  function isBigPictureMode() {
    if (typeof window.__GameGen_IS_BIG_PICTURE__ !== "undefined") {
      return window.__GameGen_IS_BIG_PICTURE__;
    }
  ...
  function scanFocusableElements() {
    ...
    // Only scan if there's a GameGen overlay active
    const activeOverlay = document.querySelector(OVERLAY_SELECTOR_STRING);

    if (!activeOverlay) {
      console.log("[Gamepad] No GameGen overlay active, skipping scan");
  ...
  function pollGamepad() {
    ...
    // Check if there's an active GameGen overlay
...
(function () {
  ...
  window.__GameGen_IS_BIG_PICTURE__ = isBigPictureMode();
  ...
  function backendLog(message) {
    try {
      if (
        ...
        Millennium.callServerMethod("gamegen", "Logger.log", {
          message: String(message),
        });
      }
    } catch (err) {
      if (typeof console !== "undefined" && console.warn) {
        console.warn("[GameGen] backendLog failed", err);
      }
    }
  }

  backendLog("GameGen script loaded");
  backendLog(
    "Mode Detection: " +
    (window.__GameGen_IS_BIG_PICTURE__ ? "BIG PICTURE MODE" : "NORMAL MODE"),
  );
  // anti-spam state
  const logState = {
    missingOnce: false,
  ...
  function fetchGamesDatabase() {
    ...
    return Millennium.callServerMethod("gamegen", "GetGamesDatabase", {
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[GameGen] Failed to fetch games database", err);
        return {};
      });
  }
  ...
  function fetchFixes(appid) {
    ...
    return Millennium.callServerMethod("gamegen", "CheckForFixes", {
      appid: appid,
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[GameGen] Failed to fetch fixes", err);
        return null;
      });
  }
  ...
  function fetchSteamGameName(appid) {
    ...
    return fetch(
      ...
      .catch(function (err) {
        backendLog(
          "GameGen: fetchSteamGameName error for " + appid + ": " + err,
        );
        return null;
      });
  }
  ...
  function applyTranslationBundle(bundle) {
    ...
    const stored = window.__GameGenI18n || {};
    if (bundle.language) {
  ...
  const DEFAULT_THEMES = {
    original: {
      ...
      bgPrimary: "#0d0f1a",
      bgSecondary: "#151929",
      bgTertiary: "rgba(30, 36, 60, 0.92)",
      bgHover: "rgba(50, 58, 95, 0.92)",
      bgContainer: "rgba(22, 28, 48, 0.7)",
      bgContainerGradient: "rgba(22, 28, 48, 0.9), #08091a",
      accent: "#7c5bf5",
      accentLight: "#a78bfa",
      accentDark: "#6344cc",
      border: "rgba(124,91,245,0.25)",
      borderHover: "rgba(124,91,245,0.7)",
      text: "#f0f0f8",
      textSecondary: "#9ca3b8",
      gradient: "linear-gradient(135deg, #7c5bf5 0%, #00d4ff 100%)",
      gradientLight: "linear-gradient(135deg, #a78bfa 0%, #38f9d7 100%)",
      shadow: "rgba(124,91,245,0.35)",
      shadowHover: "rgba(124,91,245,0.55)",
    },
  };
  ...
  function loadThemesFromBackend() {
    ...
    return Millennium.callServerMethod("gamegen", "GetThemes", {
      contentScriptQuery: "",
    })
      .then(function (res) {
        try {
  ...
  function getCurrentThemeKey() {
    try {
      const settings = window.__GameGenSettings || {};
  ...
  function generateThemeStyles(theme) {
    return `
            ...
            .gamegen-settings-overlay select,
            .gamegen-settings-manager-overlay select,
            .gamegen-overlay select,
            .gamegen-fixes-results-overlay select,
            .gamegen-loadedapps-overlay select {
            ...
            .gamegen-settings-overlay select option,
            .gamegen-settings-manager-overlay select option,
            .gamegen-overlay select option,
            .gamegen-fixes-results-overlay select option,
            .gamegen-loadedapps-overlay select option {
                background-color: ${theme.bgPrimary} !important;
                color: ${theme.text} !important;
            }
            .gamegen-settings-overlay select option:checked,
            .gamegen-settings-manager-overlay select option:checked,
            .gamegen-overlay select option:checked,
            .gamegen-fixes-results-overlay select option:checked,
            .gamegen-loadedapps-overlay select option:checked {
                background: ${theme.accent} !important;
                color: ${theme.text} !important;
            }
            .gamegen-settings-overlay select:hover,
            .gamegen-settings-manager-overlay select:hover,
            .gamegen-overlay select:hover,
            .gamegen-fixes-results-overlay select:hover,
            .gamegen-loadedapps-overlay select:hover {
                border-color: ${theme.borderHover} !important;
            }
            .gamegen-settings-overlay select:focus,
            .gamegen-settings-manager-overlay select:focus,
            .gamegen-overlay select:focus,
            .gamegen-fixes-results-overlay select:focus,
            .gamegen-loadedapps-overlay select:focus {
            ...
            .gamegen-btn:hover:not([data-disabled="1"]) {
            ...
            .gamegen-btn.primary:hover:not([data-disabled="1"]) {
            ...
            .gamegen-toggle-container {
                display: flex;
                align-items: center;
                justify-content: space-between;
                width: 100%;
            }
            .gamegen-toggle-label-wrap {
                display: flex;
            ...
            input:checked + .gamegen-slider {
                background: ${theme.gradient};
                border-color: ${theme.accent};
            }
            input:checked + .gamegen-slider:before {
                transform: translateX(24px);
            }
            .gamegen-slider:hover {
                border-color: ${theme.accent};
            }
            ...
            /* Store header button - GameGen themed icon button */
            button.gamegen-header-button {
                display: inline-flex;
                align-items: center;
            ...
            button.gamegen-header-button:hover {
                background: rgba(${theme.accent ? theme.accent.replace('#','') : '124,91,245'},0.15);
                transform: translateY(-1px);
                box-shadow: 0 6px 18px ${theme.shadow};
                border-color: ${theme.accent};
            }
            button.gamegen-header-button:focus-visible {
                outline: 2px solid ${theme.accent};
                outline-offset: 2px;
            }
            button.gamegen-header-button img,
            button.gamegen-header-button svg {
                height: 16px;
                width: 16px;
            }
        `;
  ...
  function ensureThemeStylesheet(themeKey) {
    ...
    try {
      ...
      backendLog("GameGen: Theme CSS injection failed: " + err);
    }
  }

  function ensureGameGenStyles() {
    const styleEl = document.getElementById("gamegen-styles");
    ...
    if (styleEl) {
      ...
      try {
        ...
        style.id = "gamegen-styles";
        style.textContent = styles;
        document.head.appendChild(style);
      } catch (err) {
        backendLog("GameGen: Styles injection failed: " + err);
      }
    }
  }

  function ensureFontAwesome() {
    if (document.getElementById("gamegen-fontawesome")) return;
    try {
      const link = document.createElement("link");
      link.id = "gamegen-fontawesome";
      link.rel = "stylesheet";
      link.href =
      ...
      backendLog("GameGen: Font Awesome injection failed: " + err);
    }
  }

  function showSettingsPopup() {
    if (
      document.querySelector(".gamegen-settings-overlay") ||
      settingsMenuPending
    )
      return;
    ...
    ensureTranslationsLoaded(false)
      ...
      .finally(function () {
        ...
        if (document.querySelector(".gamegen-settings-overlay")) return;

        try {
          const d = document.querySelector(".gamegen-overlay");
          if (d) d.remove();
        } catch (_) { }
        ensureGameGenStyles();
        ensureFontAwesome();
        ...
        overlay.className = "gamegen-settings-overlay";
        overlay.style.cssText =
          "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:99999;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.15s ease-out;";

        const modal = document.createElement("div");
        const colors = getThemeColors();
        modal.style.cssText = `position:relative;background:linear-gradient(145deg, rgba(20,24,42,0.95) 0%, rgba(12,14,28,0.98) 100%);color:${colors.text};border:1px solid rgba(255,255,255,0.08);border-radius:20px;width:460px;padding:24px 28px;box-shadow:0 24px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.05);animation:slideUp 0.2s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
        ...
        title.style.cssText = `display:flex;align-items:center;gap:12px;font-size:20px;color:${colors.text};font-weight:700;letter-spacing:-0.3px;`;
        const titleIcon = document.createElement("img");
        titleIcon.style.cssText = "width:24px;height:24px;border-radius:6px;";
        titleIcon.alt = "gamegen";
        try {
          Millennium.callServerMethod("gamegen", "GetIconDataUrl", {
            contentScriptQuery: "",
          }).then(function (res) {
            try {
              ...
              titleIcon.src =
                p && p.success && p.dataUrl
                  ? p.dataUrl
                  : "GameGen/gamegen-icon.png";
            } catch (_) {
              titleIcon.src = "GameGen/gamegen-icon.png";
            }
          });
        } catch (_) {
          titleIcon.src = "GameGen/gamegen-icon.png";
        ...
        titleText.textContent = t("menu.title", "GameGen · Menu");
        ...
        function createIconButton(id, iconClass, titleKey, titleFallback) {
          ...
          btn.style.cssText = `display:flex;align-items:center;justify-content:center;width:36px;height:36px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:10px;color:${btnColors.accent};font-size:16px;text-decoration:none;transition:all 0.25s cubic-bezier(0.4,0,0.2,1);cursor:pointer;`;
        ...
        if (window.__GameGen_IS_BIG_PICTURE__) {
        ...
        function createCardButton(id, key, fallback, iconClass) {
          ...
          btn.href = "#";
          const btnColors = getThemeColors();
          btn.style.cssText = `display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;flex:1;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:14px;color:${btnColors.text};font-size:11px;font-weight:500;text-decoration:none;transition:all 0.25s cubic-bezier(0.4,0,0.2,1);cursor:pointer;text-align:center;padding:16px 8px;min-width:0;`;
        ...
        removeBtn.id = "gg-settings-remove-lua";
        removeBtn.href = "#";
        ...
        removeBtn.innerHTML =
          ...
          t("menu.removeGameGen", "Remove via GameGen") +
          "</span>";
        ...
        if (checkBtn) {
          checkBtn.addEventListener("click", function (e) {
            ...
            try {
              Millennium.callServerMethod("gamegen", "CheckForUpdatesNow", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
        ...
        if (discordBtn) {
          discordBtn.addEventListener("click", function (e) {
            ...
            const url = "https://discord.gg/GameGen";
            try {
              Millennium.callServerMethod("gamegen", "OpenExternalUrl", {
                url,
                contentScriptQuery: "",
              });
            } catch (_) { }
        ...
        if (fetchApisBtn) {
          fetchApisBtn.addEventListener("click", function (e) {
            ...
            try {
              Millennium.callServerMethod("gamegen", "FetchFreeApisNow", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
                  ...
                  const successText = tr("Loaded free APIs: {count}").replace(
                    "{count}",
                    count != null ? count : "?",
                  );
                  const failText =
                    payload && payload.error
                      ...
                      : tr("Failed to load free APIs.");
                  const text = ok ? successText : failText;
                  ShowGameGenAlert("gamegen", text);
                } catch (_) { }
              });
            } catch (_) { }
          });
        ...
        if (fixesMenuBtn) {
          fixesMenuBtn.addEventListener("click", function (e) {
            ...
            try {
              ...
              const appid = match
                ? parseInt(match[1], 10)
                : window.__GameGenCurrentAppId || NaN;
              if (isNaN(appid)) {
                try {
                  overlay.remove();
                } catch (_) { }
                ...
                ShowGameGenAlert("gamegen", errText);
                return;
              }

              Millennium.callServerMethod("gamegen", "GetGameInstallPath", {
                appid,
                contentScriptQuery: "",
              })
                .then(function (pathRes) {
                  try {
                    ...
                    if (
                      ...
                      window.__GameGenGameInstallPath =
                        pathPayload.installPath;
                    }
                    window.__GameGenGameIsInstalled = isGameInstalled;
                    try {
                      overlay.remove();
                    } catch (_) { }
                    showFixesLoadingPopupAndCheck(appid);
                  } catch (err) {
                    backendLog("GameGen: GetGameInstallPath error: " + err);
                    try {
                      overlay.remove();
                    } catch (_) { }
                  }
                ...
                .catch(function () {
                  ...
                  ShowGameGenAlert("gamegen", errorText);
                });
            } catch (err) {
              backendLog("GameGen: Fixes Menu button error: " + err);
            }
          });
        }
        ...
        try {
          ...
          if (
            ...
            Millennium.callServerMethod("gamegen", "HasGameGenForApp", {
              appid,
              contentScriptQuery: "",
            }).then(function (res) {
              try {
                ...
                if (exists) {
                  const doDelete = function () {
                    try {
                      Millennium.callServerMethod(
                        ...
                        .then(function () {
                          try {
                            window.__GameGenButtonInserted = false;
                            window.__GameGenPresenceCheckInFlight = false;
                            window.__GameGenPresenceCheckAppId = undefined;
                            addGameGenButton();
                            const successText = t(
                              "menu.remove.success",
                              "GameGen removed for this app.",
                            );
                            ShowGameGenAlert("gamegen", successText);
                          } catch (err) {
                            backendLog(
                              "GameGen: post-delete cleanup failed: " + err,
                            );
                          }
                        })
                        .catch(function (err) {
                          const failureText = t(
                            "menu.remove.failure",
                            "Failed to remove GameGen.",
                          );
                          const errMsg =
                            err && err.message ? err.message : failureText;
                          ShowGameGenAlert("gamegen", errMsg);
                        });
                    } catch (err) {
                      backendLog("GameGen: doDelete failed: " + err);
                    }
                  };
                  ...
                  removeBtn.onclick = function (e) {
                    ...
                    const confirmMessage = t(
                      "menu.remove.confirm",
                      "Remove via GameGen for this game?",
                    );
                    showGameGenConfirm(
                      "gamegen",
                      confirmMessage,
  ...
  function ensureTranslationsLoaded(forceRefresh, preferredLanguage) {
    try {
      if (
        !forceRefresh &&
        window.__GameGenI18n &&
        window.__GameGenI18n.ready
      ) {
        return Promise.resolve(window.__GameGenI18n);
      }
      if (
        typeof Millennium === "undefined" ||
        typeof Millennium.callServerMethod !== "function"
      ) {
        window.__GameGenI18n = window.__GameGenI18n || {
          language: "en",
          locales: [],
          strings: {},
          ready: false,
      ...
      const settingsVals =
        ((window.__GameGenSettings || {}).values || {}).general || {};
      const useSteamLang =
      ...
      if (!targetLanguage) {
        ...
        targetLanguage = useSteamLang
          ? steamLang
          : (window.__GameGenI18n && window.__GameGenI18n.language) || "en";
      }
      return Millennium.callServerMethod("gamegen", "GetTranslations", {
        ...
        .then(function (res) {
          ...
          return window.__GameGenI18n;
        })
        .catch(function (err) {
          backendLog("GameGen: translation load failed: " + err);
          window.__GameGenI18n = window.__GameGenI18n || {
            language: "en",
            locales: [],
            strings: {},
      ...
      backendLog("GameGen: ensureTranslationsLoaded error: " + err);
      window.__GameGenI18n = window.__GameGenI18n || {
        language: "en",
        locales: [],
        strings: {},
  ...
  function translateText(key, fallback) {
    ...
    try {
      const store = window.__GameGenI18n;
      if (
        store &&
        store.strings &&
  ...
  function askRestartConfirmation() {
    showGameGenConfirm(
      "gamegen",
      tr("Restart Steam now?"),
      function () {
        try {
          Millennium.callServerMethod("gamegen", "RestartSteam", {
            contentScriptQuery: "",
          });
  ...
  function showTestPopup() {
    // Avoid duplicates
    if (document.querySelector(".gamegen-overlay")) return;
    // Close settings popup if open so modals don't overlap
    try {
      const s = document.querySelector(".gamegen-settings-overlay");
      if (s) s.remove();
    } catch (_) { }
    ...
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:99999;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const colors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.95) 0%, rgba(12,14,28,0.98) 100%);color:${colors.text};border:1px solid rgba(255,255,255,0.08);border-radius:24px;width:520px;padding:32px 36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;

    const title = document.createElement("div");
    const titleColors = getThemeColors();
    title.style.cssText = `display:flex;align-items:center;gap:12px;font-size:20px;color:${titleColors.text};margin-bottom:20px;font-weight:700;letter-spacing:-0.4px;`;
    title.className = "gamegen-title";
    const dlTitleIcon = document.createElement("i");
    dlTitleIcon.className = "fa-solid fa-cloud-arrow-down";
    dlTitleIcon.style.cssText = `color:${titleColors.accent};font-size:22px;`;
    title.appendChild(dlTitleIcon);
    const dlTitleText = document.createElement("span");
    dlTitleText.textContent = tr("Select Download Source");
    title.appendChild(dlTitleText);

    // API list container
    const apiListContainer = document.createElement("div");
    apiListContainer.className = "gamegen-api-list";
    ...
    loadingItem.textContent = tr("Loading APIs...");
    ...
    if (
      ...
      Millennium.callServerMethod("gamegen", "GetApiList", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          try {
            ...
            if (
              ...
              payload.apis.forEach((api, index) => {
                ...
                apiItem.className = `gamegen-api-item gamegen-api-${index}`;
                apiItem.setAttribute("data-api-name", api.name);
                apiItem.style.cssText = `display:flex;align-items:center;justify-content:space-between;padding:12px 16px;margin-bottom:10px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;transition:all 0.25s ease;`;

                const apiName = document.createElement("div");
                apiName.className = "gamegen-api-name";
                apiName.style.cssText = `font-size:14px;color:${colors.textSecondary};font-weight:500;`;
                apiName.textContent = api.name;

                const apiStatus = document.createElement("div");
                apiStatus.className = "gamegen-api-status";
    ...
    progressWrap.className = "gamegen-progress-wrap";
    ...
    cancelBtn.className = "gamegen-btn gamegen-cancel-btn";
    cancelBtn.style.cssText =
      "display:none;align-items:center;justify-content:center;text-align:center;";
    cancelBtn.innerHTML = `<span>${tr("Cancel")}</span>`;
    cancelBtn.href = "#";
    ...
    hideBtn.className = "gamegen-btn gamegen-hide-btn";
    hideBtn.style.cssText =
      "display:flex;align-items:center;justify-content:center;text-align:center;";
    hideBtn.innerHTML = `<span>${tr("Hide")}</span>`;
    hideBtn.href = "#";
    ...
    function cancelOperation() {
      ...
      try {
        ...
        if (
          ...
          Millennium.callServerMethod("gamegen", "CancelAddViaGameGen", {
            appid,
            contentScriptQuery: "",
          });
        }
      ...
      const status = overlay.querySelector(".gamegen-status");
      if (status) status.textContent = tr("Cancelled");
      const cancelBtn = overlay.querySelector(".gamegen-cancel-btn");
      if (cancelBtn) cancelBtn.style.display = "none";
      const hideBtn = overlay.querySelector(".gamegen-hide-btn");
      if (hideBtn) hideBtn.innerHTML = `<span>${tr("Close")}</span>`;
      // Hide progress UI
      const wrap = overlay.querySelector(".gamegen-progress-wrap");
      const progressInfo = overlay.querySelector(".gamegen-progress-info");
  ...
  function showFixesResultsPopup(data, isGameInstalled) {
    if (document.querySelector(".gamegen-fixes-results-overlay")) return;
    // Close other popups
    try {
      const d = document.querySelector(".gamegen-overlay");
      if (d) d.remove();
    ...
    try {
      const f = document.querySelector(".gamegen-fixes-results-overlay");
      if (f) f.remove();
    } catch (_) { }
    try {
      const l = document.querySelector(".gamegen-loading-fixes-overlay");
      if (l) l.remove();
    } catch (_) { }
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "gamegen-fixes-results-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:99999;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const colors = getThemeColors();
    modal.style.cssText = `position:relative;background:linear-gradient(145deg, rgba(20,24,42,0.95) 0%, rgba(12,14,28,0.98) 100%);color:${colors.text};border:1px solid rgba(255,255,255,0.08);border-radius:28px;width:640px;max-height:85vh;display:flex;flex-direction:column;padding:32px;box-shadow:0 32px 100px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.05);animation:slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1);backdrop-filter:blur(16px);`;
    ...
    const title = document.createElement("div");
    title.style.cssText = `display:flex;align-items:center;gap:12px;font-size:20px;color:${colors.text};font-weight:700;letter-spacing:-0.4px;`;
    const titleIcon = document.createElement("i");
    titleIcon.className = "fa-solid fa-wrench";
    titleIcon.style.cssText = `color:${colors.accent};font-size:22px;`;
    const titleText = document.createElement("span");
    titleText.textContent = tr("GameGen · Fixes Menu");
    title.appendChild(titleIcon);
    title.appendChild(titleText);
    ...
    body.style.cssText = `flex:1 1 auto;overflow-y:auto;padding:24px;border:1px solid rgba(255,255,255,0.06);border-radius:18px;background:rgba(255,255,255,0.02);backdrop-filter:blur(4px);`;
    ...
    gameName.textContent = data.gameName || tr("Unknown Game");

    if (
      !data.gameName ||
      data.gameName === "Unknown Game" ||
      data.gameName === tr("Unknown Game") ||
    ...
    function createFixButton(label, text, icon, isSuccess, onClick) {
      ...
      btn.href = "#";
      const btnColors = getThemeColors();
      btn.style.cssText = `display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;flex:1 1 calc(50% - 10px);min-width:140px;box-sizing:border-box;padding:18px 12px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:16px;color:${btnColors.text};text-decoration:none;transition:all 0.25s cubic-bezier(0.4, 0, 0.2, 1);cursor:pointer;text-align:center;`;
      ...
      try {
        ...
        const applyLabel = tr("Apply");
        const onlineUnsteamLabel = tr("Online Fix (Unsteam)");
        const noOnlineLabel = tr("No online-fix");
        const unfixLabel = tr("Un-Fix (verify game)");
        const noGenericLabel = tr("No generic fix");
    ...
    const genericSection = createFixButton(
      tr("Generic Fix"),
      genericStatus === 200 ? tr("Apply") : tr("No generic fix"),
      ...
      function (e) {
        ...
        if (genericStatus === 200 && isGameInstalled) {
          const genericUrl =
            "https://files.GameGen.work/GameBypasses/" + data.appid + ".zip";
          applyFix(
            data.appid,
            genericUrl,
            tr("Generic Fix"),
    ...
    const onlineSection = createFixButton(
      tr("Online Fix"),
      onlineStatus === 200 ? tr("Apply") : tr("No online-fix"),
      ...
      function (e) {
        ...
        if (onlineStatus === 200 && isGameInstalled) {
          const onlineUrl =
            data.onlineFix.url ||
            "https://files.GameGen.work/OnlineFix1/" + data.appid + ".zip";
          applyFix(
            data.appid,
            onlineUrl,
            tr("Online Fix"),
    ...
    const aioSection = createFixButton(
      ...
      function (e) {
        ...
        if (isGameInstalled) {
          const downloadUrl =
            "https://github.com/madoiscool/gg_api_links/releases/download/unsteam/Win64.zip";
          applyFix(
            data.appid,
            downloadUrl,
            tr("Online Fix (Unsteam)"),
    ...
    const creditTemplate = tr("Only possible thanks to {name} 💜");
    creditMsg.innerHTML = creditTemplate.replace(
      "{name}",
      `<a href="#" id="gg-shayenvi-link" style="color:${creditColors.accent};text-decoration:none;font-weight:600;">ShayneVi</a>`,
    );

    // Wire up ShayneVi link
    setTimeout(function () {
      const shayenviLink = overlay.querySelector("#gg-shayenvi-link");
      if (shayenviLink) {
    ...
    gameFolderBtn.className = "gamegen-btn";
    gameFolderBtn.innerHTML = `<span><i class="fa-solid fa-folder" style="margin-right: 8px;"></i>${tr("Game folder")}</span>`;
    gameFolderBtn.href = "#";
    gameFolderBtn.onclick = function (e) {
      e.preventDefault();
      if (window.__GameGenGameInstallPath) {
        try {
          Millennium.callServerMethod("gamegen", "OpenGameFolder", {
            path: window.__GameGenGameInstallPath,
            contentScriptQuery: "",
          });
        } catch (err) {
          backendLog("GameGen: Failed to open game folder: " + err);
        }
      }
    };
    ...
    function startUnfix(appid) {
      try {
        Millennium.callServerMethod("gamegen", "UnFixGame", {
          appid: appid,
          installPath: window.__GameGenGameInstallPath,
          contentScriptQuery: "",
        })
          .then(function (res) {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
            if (payload && payload.success) {
              ...
              const errorMsg =
                errorKey &&
                  ...
                  ? t(errorKey)
                  : errorKey || tr("Failed to start un-fix");
              ShowGameGenAlert("gamegen", errorMsg);
            }
          })
          .catch(function () {
            const msg = tr("Error starting un-fix");
            ShowGameGenAlert("gamegen", msg);
          });
      } catch (err) {
        backendLog("GameGen: Un-Fix start error: " + err);
      }
    }
  }

  function showFixesLoadingPopupAndCheck(appid) {
    if (document.querySelector(".gamegen-loading-fixes-overlay")) return;
    try {
      const d = document.querySelector(".gamegen-overlay");
      if (d) d.remove();
    } catch (_) { }
    ...
    try {
      const f = document.querySelector(".gamegen-fixes-overlay");
      if (f) f.remove();
    } catch (_) { }
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "gamegen-loading-fixes-overlay";
    overlay.style.cssText =
    ...
    title.textContent = tr("Loading fixes...");
    ...
    body.textContent = tr("Checking availability…");
    ...
    fetchFixes(appid)
      .then(function (payload) {
        if (payload && payload.success) {
          const isGameInstalled = window.__GameGenGameIsInstalled === true;
          showFixesResultsPopup(payload, isGameInstalled);
        } else {
          const errText =
            payload && payload.error
              ? String(payload.error)
              : tr("Failed to check for fixes.");
          ShowGameGenAlert("gamegen", errText);
        }
      })
      .catch(function () {
        const msg = tr("Error checking for fixes");
        ShowGameGenAlert("gamegen", msg);
      })
      .finally(function () {
  ...
  function applyFix(appid, downloadUrl, fixType, gameName, resultsOverlay) {
    try {
      ...
      if (!window.__GameGenGameInstallPath) {
        const msg = tr("Game install path not found");
        ShowGameGenAlert("gamegen", msg);
        return;
      }

      backendLog("GameGen: Applying fix " + fixType + " for appid " + appid);

      // Start the download and extraction process
      Millennium.callServerMethod("gamegen", "ApplyGameFix", {
        appid: appid,
        ...
        .then(function (res) {
          try {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
            if (payload && payload.success) {
              // Show download progress popup similar to Add via GameGen
              ...
              const errorMsg =
                errorKey &&
                  (errorKey.startsWith("menu.error.") ||
                    errorKey.startsWith("common."))
                  ? t(errorKey)
                  : errorKey || tr("Failed to start fix download");
              ShowGameGenAlert("gamegen", errorMsg);
            }
          } catch (err) {
            backendLog("GameGen: ApplyGameFix response error: " + err);
            const msg = tr("Error applying fix");
            ShowGameGenAlert("gamegen", msg);
          }
        })
        .catch(function (err) {
          backendLog("GameGen: ApplyGameFix error: " + err);
          const msg = tr("Error applying fix");
          ShowGameGenAlert("gamegen", msg);
        });
    } catch (err) {
      backendLog("GameGen: applyFix error: " + err);
    }
  }

  // Show fix download progress popup
  function showFixDownloadProgress(appid, fixType) {
    // Reuse the download popup UI from Add via GameGen
    if (document.querySelector(".gamegen-overlay")) return;
    ...
    title.textContent = tr("Applying {fix}").replace("{fix}", fixType);
    ...
    body.innerHTML =
      '<div id="gg-fix-progress-msg">' + tr("Downloading...") + "</div>";

    const btnRow = document.createElement("div");
    btnRow.className = "gg-fix-btn-row";
    btnRow.style.cssText =
      "margin-top:16px;display:flex;gap:12px;justify-content:center;";

    const hideBtn = document.createElement("a");
    hideBtn.href = "#";
    hideBtn.className = "gamegen-btn";
    ...
    const cancelBtn = document.createElement("a");
    cancelBtn.href = "#";
    cancelBtn.className = "gamegen-btn primary";
    ...
    cancelBtn.onclick = function (e) {
      ...
      if (span) span.textContent = tr("Cancelling...");
      const msgEl = document.getElementById("gg-fix-progress-msg");
      if (msgEl) msgEl.textContent = tr("Cancelling...");
      Millennium.callServerMethod("gamegen", "CancelApplyFix", {
        appid: appid,
        contentScriptQuery: "",
      })
        .then(function (res) {
          try {
            ...
            if (!payload || payload.success !== true) {
              throw new Error(
                (payload && payload.error) || tr("Cancellation failed"),
              );
            }
          } catch (err) {
            cancelBtn.dataset.pending = "0";
            if (span) span.textContent = tr("Cancel");
            const msgEl2 = document.getElementById("gg-fix-progress-msg");
            if (msgEl2 && msgEl2.dataset.last)
              msgEl2.textContent = msgEl2.dataset.last;
            backendLog("GameGen: CancelApplyFix response error: " + err);
            const msg = tr("Failed to cancel fix download");
            ShowGameGenAlert("gamegen", msg);
          }
        })
        .catch(function (err) {
          ...
          if (span2) span2.textContent = tr("Cancel");
          const msgEl2 = document.getElementById("gg-fix-progress-msg");
          if (msgEl2 && msgEl2.dataset.last)
            msgEl2.textContent = msgEl2.dataset.last;
          backendLog("GameGen: CancelApplyFix error: " + err);
          const msg = tr("Failed to cancel fix download");
          ShowGameGenAlert("gamegen", msg);
        });
    };
  ...
  function replaceFixButtonsWithClose(overlayEl) {
    if (!overlayEl) return;
    const btnRow = overlayEl.querySelector(".gg-fix-btn-row");
    if (!btnRow) return;
    btnRow.innerHTML = "";
    btnRow.style.cssText =
    ...
    closeBtn.href = "#";
    closeBtn.className = "gamegen-btn primary";
    closeBtn.style.minWidth = "140px";
    closeBtn.innerHTML = `<span>${tr("Close")}</span>`;
  ...
  function pollFixProgress(appid, fixType) {
    const poll = function () {
      try {
        const overlayEl = document.querySelector(".gamegen-overlay");
        if (!overlayEl) return; // Stop if overlay was closed

        Millennium.callServerMethod("gamegen", "GetApplyFixStatus", {
          appid: appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
              ...
              if (state.status === "downloading") {
                const pct =
                  state.totalBytes > 0
                    ...
                    : 0;
                if (msgEl) {
                  msgEl.textContent = tr("Downloading: {percent}%").replace(
                    "{percent}",
                    pct,
                  );
                ...
                if (msgEl) {
                  msgEl.textContent = tr("Extracting to game folder...");
                  msgEl.dataset.last = msgEl.textContent;
                }
                setTimeout(poll, 500);
              } else if (state.status === "cancelled") {
                if (msgEl)
                  msgEl.textContent = tr("Cancelled: {reason}").replace(
                    "{reason}",
                    state.error || tr("Cancelled by user"),
                  );
                replaceFixButtonsWithClose(overlayEl);
                return;
              } else if (state.status === "done") {
                if (msgEl)
                  msgEl.textContent = tr("{fix} applied successfully!").replace(
                    "{fix}",
                    fixType,
                  );
                replaceFixButtonsWithClose(overlayEl);
                ...
                if (msgEl)
                  msgEl.textContent = tr("Failed: {error}").replace(
                    "{error}",
                    state.error || tr("Unknown error"),
                  );
                replaceFixButtonsWithClose(overlayEl);
                return; // Stop polling
              } else {
            ...
            backendLog("GameGen: GetApplyFixStatus error: " + err);
          }
        });
      } catch (err) {
        backendLog("GameGen: pollFixProgress error: " + err);
      }
    };
    setTimeout(poll, 500);
  }
  ...
  function showUnfixProgress(appid) {
    ...
    try {
      const old = document.querySelector(".gamegen-unfix-overlay");
      if (old) old.remove();
    } catch (_) { }
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "gamegen-unfix-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";
    ...
    title.textContent = tr("Un-Fixing game");

    const body = document.createElement("div");
    body.style.cssText =
      "font-size:15px;line-height:1.6;margin-bottom:20px;color:#c7d5e0;";
    body.innerHTML =
      '<div id="gg-unfix-progress-msg">' +
      tr("Removing fix files...") +
      "</div>";
  ...
  function pollUnfixProgress(appid) {
    const poll = function () {
      try {
        const overlayEl = document.querySelector(".gamegen-unfix-overlay");
        if (!overlayEl) return; // Stop if overlay was closed

        Millennium.callServerMethod("gamegen", "GetUnfixStatus", {
          appid: appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            ...
            if (payload && payload.success && payload.state) {
              const state = payload.state;
              const msgEl = document.getElementById("gg-unfix-progress-msg");

              if (state.status === "removing") {
                if (msgEl)
                  msgEl.textContent =
                    state.progress || tr("Removing fix files...");
                // Continue polling
                setTimeout(poll, 500);
              } else if (state.status === "done") {
                ...
                setTimeout(function () {
                  try {
                    ...
                    backendLog("GameGen: Running verify for appid " + appid);
                  } catch (_) { }
                }, 1000);
            ...
            backendLog("GameGen: GetUnfixStatus error: " + err);
          }
        });
      } catch (err) {
        backendLog("GameGen: pollUnfixProgress error: " + err);
      }
    };
    setTimeout(poll, 500);
  }
  ...
  function fetchSettingsConfig(forceRefresh) {
    try {
      if (
        !forceRefresh &&
        window.__GameGenSettings &&
        Array.isArray(window.__GameGenSettings.schema)
      ) {
        return Promise.resolve(window.__GameGenSettings);
      }
    } catch (_) { }
    ...
    if (
      ...
      return Promise.reject(new Error(tr("GameGen backend unavailable")));
    }

    return Millennium.callServerMethod("gamegen", "GetSettingsConfig", {
      contentScriptQuery: "",
    }).then(function (res) {
      const payload = typeof res === "string" ? JSON.parse(res) : res;
      if (!payload || payload.success !== true) {
      ...
      window.__GameGenSettings = config;
      return config;
    });
  }
  ...
  function showSettingsManagerPopup(forceRefresh, onBack) {
    if (document.querySelector(".gamegen-settings-manager-overlay")) return;

    try {
      const mainOverlay = document.querySelector(".gamegen-settings-overlay");
    ...
    const overlay = document.createElement("div");
    overlay.className = "gamegen-settings-manager-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100000;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const settingsModalColors = getThemeColors();
    modal.style.cssText = `position:relative;background:linear-gradient(145deg, rgba(20,24,42,0.95) 0%, rgba(12,14,28,0.98) 100%);color:${settingsModalColors.text};border:1px solid rgba(255,255,255,0.08);border-radius:28px;width:750px;max-height:88vh;padding:0;display:flex;flex-direction:column;box-shadow:0 32px 100px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.05);animation:slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1);overflow:hidden;backdrop-filter:blur(16px);`;

    const header = document.createElement("div");
    const settingsHeaderColors = getThemeColors();
    header.style.cssText = `display:flex;justify-content:space-between;align-items:center;padding:24px 32px 20px;border-bottom:1px solid rgba(255,255,255,0.06);`;
    ...
    title.textContent = t("settings.title", "GameGen · Settings");
    ...
    searchInput.id = "gamegen-settings-search";
    ...
    contentWrap.id = "gamegen-content-wrap";
    ...
    function applySearchFilter() {
      ...
      const fixesSection = document.getElementById(
        "gamegen-installed-fixes-section",
      );
      ...
      if (luaSection && query && luaItems.length > 0 && visibleLua === 0) {
        if (!luaEmptySearch) {
          ...
          const listContainer = luaSection.querySelector("#gamegen-lua-list");
          if (listContainer) listContainer.appendChild(emptyEl);
        }
    ...
    scrollbarStyle.textContent =
      "#gamegen-content-wrap::-webkit-scrollbar { width: 8px; } " +
      "#gamegen-content-wrap::-webkit-scrollbar-track { background: transparent; } " +
      "#gamegen-content-wrap::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.15); border-radius: 4px; } " +
      "#gamegen-content-wrap::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.25); }";
    ...
    function setStatus(text, color) {
      let statusLine = contentWrap.querySelector(".gamegen-settings-status");
      if (!statusLine) {
        statusLine = document.createElement("div");
        statusLine.className = "gamegen-settings-status";
    ...
    function updateSaveState() {
      ...
      if (foundMorrenusKey && morrenusKey && !isValid) {
        setStatus(tr("Invalid Morrenus API Key format"), "#ff5c5c");
      }
    }
    ...
    function renderSettings() {
      ...
      for (let i = 0; i < state.config.schema.length; i++) {
        ...
        for (let j = 0; j < options.length; j++) {
          ...
          labelWrap.className = "gamegen-toggle-label-wrap";
          ...
          if (option.description) {
            ...
            if (
              ...
              const linkHtml = `<a href="${url}" id="gg-morrenus-link" style="color:${optDescColors.accent};text-decoration:underline;">manifest.morrenus.xyz</a>`;
              ...
              setTimeout(() => {
                const link = document.getElementById("gg-morrenus-link");
                if (link) {
                  link.onclick = (e) => {
                    e.preventDefault();
                    Millennium.callServerMethod("gamegen", "OpenExternalUrl", {
          ...
          if (option.type === "toggle") {
            optionEl.classList.add("gamegen-toggle-container");
            ...
            toggleLabel.className = "gamegen-toggle";
            ...
            slider.className = "gamegen-slider";
            ...
            if (option.type === "select") {
              ...
              selectEl.addEventListener("change", function () {
                ...
                if (group.key === "general" && option.key === "theme") {
                  try {
                    backendLog(
                      "GameGen: Theme change detected, new value: " +
                      selectEl.value,
                    );
                  } catch (_) { }
                  ...
                  if (
                    window.__GameGenSettings &&
                    window.__GameGenSettings.values
                  ) {
                    if (!window.__GameGenSettings.values.general) {
                      window.__GameGenSettings.values.general = {};
                    }
                    window.__GameGenSettings.values.general.theme =
                      selectEl.value;
                    try {
                      backendLog(
                        "GameGen: Updated cache, theme is now: " +
                        window.__GameGenSettings.values.general.theme,
                      );
                    } catch (_) { }
                  }
                  ...
                  setTimeout(function () {
                    ...
                    const contentWrapEl =
                      overlay &&
                      overlay.querySelector("#gamegen-content-wrap");
                    if (contentWrapEl) {
              ...
              if (option.key === "morrenusApiKey") {
                ...
                const updateStats = function (key) {
                  ...
                  statsDiv.innerHTML =
                    ...
                    tr("Checking key...");
                  Millennium.callServerMethod("gamegen", "GetMorrenusStats", {
                    api_key: key,
                    contentScriptQuery: "",
                  })
                        ...
                        statsDiv.innerHTML = `
                          <div style="padding:10px;background:rgba(255,255,255,0.04);border:1px solid ${textColors.borderRgba || "rgba(255,255,255,0.1)"};border-radius:8px;">
                            ...
                            <div style="display:flex;justify-content:space-between;margin-bottom:4px;color:${usageColor};font-weight:500;">
                                <span><i class="fa-solid fa-chart-pie" style="margin-right:6px;"></i>${tr("Usage")}</span>
                                <span>${usage} / ${limit}</span>
                            </div>
                            <div style="display:flex;justify-content:space-between;color:${textColors.textSecondary};">
                                <span><i class="fa-solid fa-clock" style="margin-right:6px;"></i>${tr("Expires")}</span>
    ...
    function renderInstalledFixesSection() {
      ...
      sectionEl.id = "gamegen-installed-fixes-section";
      ...
      listContainer.id = "gamegen-fixes-list";
    ...
    function loadInstalledFixes(container) {
      ...
      Millennium.callServerMethod("gamegen", "GetInstalledFixes", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          const response = typeof res === "string" ? JSON.parse(res) : res;
          backendLog(
            "GameGen: GetInstalledFixes response: " +
            JSON.stringify(response).substring(0, 200),
          );
          if (!response || !response.success) {
            backendLog(
              "GameGen: GetInstalledFixes failed - response: " +
        ...
        .catch(function (err) {
          backendLog("GameGen: GetInstalledFixes catch error: " + err);
    ...
    function renderInstalledLuaSection() {
      const sectionEl = document.createElement("div");
      sectionEl.id = "gamegen-installed-lua-section";
      ...
      const listContainer = document.createElement("div");
      listContainer.id = "gamegen-lua-list";
      listContainer.style.cssText = "min-height:50px;";
      sectionEl.appendChild(listContainer);
    ...
    function loadInstalledLuaScripts(container) {
      ...
      Millennium.callServerMethod("gamegen", "GetInstalledLuaScripts", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          const response = typeof res === "string" ? JSON.parse(res) : res;
          ...
          if (hasUnknownGames) {
            ...
            infoBanner.innerHTML =
              ...
              t(
                ...
                "Games showing 'Unknown Game' were installed manually (not via GameGen).",
              ) +
              "</span>";
      ...
      luaDeleteBtn.addEventListener("click", function (e) {
        ...
        showGameGenConfirm(
          ...
          function () {
            ...
            Millennium.callServerMethod("gamegen", "DeleteGameGenForApp", {
              appid: script.appid,
              contentScriptQuery: "",
            })
              .then(function (res) {
    ...
    saveBtn.addEventListener("click", function (e) {
      ...
      try {
        backendLog(
          "GameGen: collectChanges payload " + JSON.stringify(changes),
        );
      } catch (_) { }
      ...
      try {
        backendLog(
          "GameGen: sending settings payload " + JSON.stringify(payloadToSend),
        );
      } catch (_) { }
      // Pass flattened keys so Millennium handles the RPC arguments as expected.
      Millennium.callServerMethod("gamegen", "ApplySettingsChanges", {
        contentScriptQuery: "",
        ...
        .then(function (res) {
          ...
          try {
            if (window.__GameGenSettings) {
              window.__GameGenSettings.values = JSON.parse(
                JSON.stringify(state.config.values),
              );
              window.__GameGenSettings.schemaVersion =
                state.config.schemaVersion;
              window.__GameGenSettings.lastFetched = Date.now();
              if (
                response &&
                response.translations &&
                typeof response.translations === "object"
              ) {
                window.__GameGenSettings.translations = response.translations;
              }
              if (response && response.language) {
                window.__GameGenSettings.language = response.language;
              }
            }
          } catch (_) { }
          ...
          try {
            if (window.__GameGenSettings) {
              window.__GameGenSettings.schema = null;
            }
          } catch (_) { }
          ...
          if (
            ...
            applyTranslationBundle({
              language:
                response.language ||
                (window.__GameGenI18n && window.__GameGenI18n.language) ||
                "en",
              locales:
                (window.__GameGenI18n && window.__GameGenI18n.locales) ||
  ...
  function closeSettingsOverlay() {
    try {
      ...
      var list = document.getElementsByClassName("gamegen-settings-overlay");
      ...
      var list2 = document.getElementsByClassName("gamegen-overlay");
  ...
  function showGameGenAlert(title, message, onClose) {
    if (document.querySelector(".gamegen-alert-overlay")) return;

    ensureGameGenStyles();
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "gamegen-alert-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100001;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const alertModalColors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.98) 0%, rgba(12,14,28,0.99) 100%);color:${alertModalColors.text};border:1px solid rgba(255,255,255,0.1);border-radius:24px;width:420px;padding:36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
    ...
    titleEl.textContent = String(title || "gamegen");
  ...
  function ShowGameGenAlert(title, message) {
    try {
      showGameGenAlert(title, message);
    } catch (err) {
      backendLog("GameGen: Alert error, falling back: " + err);
      try {
        alert(String(title) + "\n\n" + String(message));
      } catch (_) { }
    }
  ...
  function showGameGenConfirm(title, message, onConfirm, onCancel) {
    // Always close settings popup first so the confirm is visible on top
    closeSettingsOverlay();

    // Create custom modern confirmation dialog
    if (document.querySelector(".gamegen-confirm-overlay")) return;

    ensureGameGenStyles();
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "gamegen-confirm-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100001;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const confirmColors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.98) 0%, rgba(12,14,28,0.99) 100%);color:${confirmColors.text};border:1px solid rgba(255,255,255,0.1);border-radius:24px;width:420px;padding:36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
    ...
    messageEl.textContent = String(message || tr("Are you sure?"));
    ...
    const cancelBtn = document.createElement("a");
    cancelBtn.href = "#";
    cancelBtn.className = "gamegen-btn";
    cancelBtn.style.cssText =
    ...
    confirmBtn.href = "#";
    confirmBtn.className = "gamegen-btn primary";
    confirmBtn.style.cssText =
      "flex:1;display:flex;align-items:center;justify-content:center;text-align:center;";
    confirmBtn.innerHTML = `<span>${tr("Confirm")}</span>`;
  ...
  function showDlcWarning(appid, fullgameAppid, fullgameName) {
    ...
    closeSettingsOverlay();
    if (document.querySelector(".gamegen-dlc-warning-overlay")) return;

    ensureGameGenStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "gamegen-dlc-warning-overlay gamegen-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100001;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const colors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.98) 0%, rgba(12,14,28,0.99) 100%);color:${colors.text};border:1px solid rgba(255,255,255,0.1);border-radius:24px;width:420px;padding:36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
  ...
  function showGameGenPlayableWarning(message, onProceed, onCancel) {
    // Close settings so modal is visible
    closeSettingsOverlay();
    if (document.querySelector(".gamegen-playable-warning-overlay")) return;

    ensureGameGenStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "gamegen-playable-warning-overlay gamegen-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100001;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const playableColors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.98) 0%, rgba(12,14,28,0.99) 100%);color:${playableColors.text};border:1px solid rgba(255,255,255,0.1);border-radius:24px;width:420px;padding:36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
    ...
    proceedBtn.href = "#";
    proceedBtn.className = "gamegen-btn primary";
    proceedBtn.style.cssText =
      "flex:1;display:flex;align-items:center;justify-content:center;text-align:center;";
    proceedBtn.innerHTML = `<span>${tr("Proceed")}</span>`;
  ...
  function showMillenniumDisclaimerModal() {
    if (document.querySelector(".gamegen-disclaimer-overlay")) return;

    ensureGameGenStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "gamegen-disclaimer-overlay gamegen-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(6,8,18,0.85);backdrop-filter:blur(20px) saturate(180%);z-index:100005;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";

    const modal = document.createElement("div");
    const disclaimerColors = getThemeColors();
    modal.style.cssText = `background:linear-gradient(145deg, rgba(20,24,42,0.98) 0%, rgba(12,14,28,0.99) 100%);color:${disclaimerColors.text};border:1px solid rgba(255,255,255,0.1);border-radius:24px;width:460px;padding:36px;box-shadow:0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,0.04);animation:slideUp 0.25s cubic-bezier(0.4, 0, 0.2, 1);backdrop-filter:blur(12px);`;
    ...
    line1.textContent = t(
      "disclaimer.line1",
      "GameGen is not affiliated with Millennium",
    );
    ...
    confirmBtn.onclick = function (e) {
      ...
      if (input.value.trim().toLowerCase() === expectedPhrase) {
        localStorage.setItem("GameGen millennium disclaimer accepted", "1");
        overlay.remove();
      }
    };
  ...
  function ensureStyles() {
    if (!document.getElementById("gamegen-spacing-styles")) {
      const style = document.createElement("style");
      style.id = "gamegen-spacing-styles";
      style.textContent = `
                .gamegen-restart-button { margin-left: 6px !important; margin-right: 6px !important; }
                .gamegen-button { margin-right: 0 !important; position: relative !important; }
                .gamegen-pills-container {
                ...
                .gamegen-pill.red { background: rgba(255, 80, 80, 0.15); color: #ff5050; border: 1px solid rgba(255, 80, 80, 0.3); }
                .gamegen-pill.green { background: rgba(92, 184, 92, 0.15); color: #5cb85c; border: 1px solid rgba(92, 184, 92, 0.3); }
                .gamegen-pill.yellow { background: rgba(255, 193, 7, 0.15); color: #ffc107; border: 1px solid rgba(255, 193, 7, 0.3); }
                .gamegen-pill.orange { background: rgba(255, 136, 0, 0.15); color: #ff8800; border: 1px solid rgba(255, 136, 0, 0.3); }
                .gamegen-pill.gray { background: rgba(150, 150, 150, 0.15); color: #a0a0a0; border: 1px solid rgba(150, 150, 150, 0.3); }
            `;
  ...
  function updateButtonTranslations() {
    try {
      ...
      const restartBtn = document.querySelector(".gamegen-restart-button");
      if (restartBtn) {
        const restartText = tr("Restart Steam");
      ...
      // Update Add via GameGen button
      const GameGenBtn = document.querySelector(".gamegen-button");
      if (GameGenBtn) {
        const addViaText = tr("Add via GameGen");
        GameGenBtn.title = addViaText;
        GameGenBtn.setAttribute("data-tooltip-text", addViaText);
        const span = GameGenBtn.querySelector("span");
        if (span) {
          span.textContent = addViaText;
        }
      }
    } catch (err) {
      backendLog("GameGen: updateButtonTranslations error: " + err);
    }
  }

  // Function to add the GameGen button
  ...
  function addGameGenButton() {
    ...
    if (window.__GameGenLastUrl !== currentUrl) {
      // Page changed - reset button insertion flag and update translations
      window.__GameGenLastUrl = currentUrl;
      window.__GameGenButtonInserted = false;
      window.__GameGenRestartInserted = false;
      window.__GameGenIconInserted = false;
      window.__GameGenHeaderInserted = false;
      window.__GameGenPresenceCheckInFlight = false;
      window.__GameGenPresenceCheckAppId = undefined;
    ...
    if (
      headerContainer &&
      !document.querySelector(".gamegen-header-button") &&
      !window.__GameGenHeaderInserted
    ) {
      ensureGameGenStyles();
      const headerBtn = document.createElement("button");
      headerBtn.type = "button";
      headerBtn.className = "gamegen-header-button Focusable";
      headerBtn.tabIndex = "0";
      headerBtn.title = "GameGen Settings";
      headerBtn.setAttribute("data-tooltip-text", "GameGen Settings");
      ...
      window.__GameGenHeaderInserted = true;
      backendLog("Inserted store header button");
    }

    // Check if we're in Big Picture mode
    const isBigPicture = window.__GameGen_IS_BIG_PICTURE__;
    ...
    if (targetContainer) {
      ...
      // Insert a Restart Steam button between Community Hub and our GameGen button
      try {
        if (
          !document.querySelector(".gamegen-restart-button") &&
          !window.__GameGenRestartInserted
        ) {
          ensureStyles();
          ...
          if (referenceBtn && referenceBtn.className) {
            restartBtn.className =
              referenceBtn.className + " gamegen-restart-button";
          } else {
            restartBtn.className =
              "btnv6_blue_hoverfade btn_medium gamegen-restart-button";
          }
          restartBtn.href = "#";
          const restartText = tr("Restart Steam");
          restartBtn.title = restartText;
          ...
          window.__GameGenRestartInserted = true;
      ...
      const existingBtn = document.querySelector(".gamegen-button");
      if (existingBtn) {
        ensureTranslationsLoaded(false).then(function () {
          updateButtonTranslations();
        });
      ...
      if (!existingBtn && !window.__GameGenButtonInserted) {
        // Create the GameGen button modeled after existing SteamDB/PCGW buttons
        // In Big Picture mode, use queue button as reference; otherwise use first link in container
        ...
        // Use same custom button for both modes
        const GameGenButton = document.createElement("a");
        GameGenButton.href = "#";
        // Copy classes from an existing button to match look-and-feel, but set our own label
        if (referenceBtn && referenceBtn.className) {
          GameGenButton.className =
            referenceBtn.className + " gamegen-button";
        } else {
          GameGenButton.className =
            "btnv6_blue_hoverfade btn_medium gamegen-button";
        }
        const span = document.createElement("span");
        const addViaText = tr("Add via GameGen");
        span.textContent = addViaText;
        GameGenButton.appendChild(span);
        // Tooltip/title
        GameGenButton.title = addViaText;
        GameGenButton.setAttribute("data-tooltip-text", addViaText);

        // Normalize margins to match native buttons
        try {
          if (referenceBtn) {
            const cs = window.getComputedStyle(referenceBtn);
            GameGenButton.style.marginLeft = cs.marginLeft;
            GameGenButton.style.marginRight = cs.marginRight;
          }
        } catch (_) { }

        // Local click handler suppressed; delegated handler manages actions
        GameGenButton.addEventListener("click", function (e) {
          e.preventDefault();
          backendLog(
            "GameGen button clicked (delegated handler will process)",
          );
        });

        // Before inserting, ask backend if GameGen already exists for this appid
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            if (
              window.__GameGenPresenceCheckInFlight &&
              window.__GameGenPresenceCheckAppId === appid
            ) {
              return;
            }
            window.__GameGenPresenceCheckInFlight = true;
            window.__GameGenPresenceCheckAppId = appid;
            window.__GameGenCurrentAppId = appid;
            Millennium.callServerMethod("gamegen", "HasGameGenForApp", {
              appid,
              contentScriptQuery: "",
            }).then(function (res) {
              try {
                ...
                if (payload && payload.success && payload.exists === true) {
                  backendLog(
                    "GameGen already present for this app; not inserting button",
                  );
                  window.__GameGenPresenceCheckInFlight = false;
                ...
                if (
                  !document.querySelector(".gamegen-button") &&
                  !window.__GameGenButtonInserted
                ) {
                  // Insert after restart button (order: Restart → Add)
                  const restartExisting = steamdbContainer.querySelector(
                    ".gamegen-restart-button",
                  );
                  if (restartExisting && restartExisting.after) {
                    restartExisting.after(GameGenButton);
                  } else if (referenceBtn && referenceBtn.after) {
                    referenceBtn.after(GameGenButton);
                  } else {
                    steamdbContainer.appendChild(GameGenButton);
                  }
                  window.__GameGenButtonInserted = true;
                  backendLog("GameGen button inserted");
                }
                window.__GameGenPresenceCheckInFlight = false;
              } catch (_) {
                if (
      ...
      try {
        ...
        if (!isNaN(appid)) {
          const pillBtn = steamdbContainer.querySelector(".gamegen-button");
          if (pillBtn) {
            ...
            if (
              ...
              fetchGamesDatabase().then(function (db) {
                const btn = steamdbContainer.querySelector(".gamegen-button");
                if (!btn) return;
                ...
                if (!pillsContainer) {
                  ...
                  pillsContainer.className = "gamegen-pills-container";
                ...
                fetchFixes(appid).then(function (fixesData) {
                  ...
                  // reset button state
                  const btn =
                    steamdbContainer.querySelector(".gamegen-button");
                  if (btn) {
                    btn.style.opacity = "";
                    ...
                    if (span && span.textContent === "Unplayable") {
                      span.textContent = tr("Add via GameGen");
                    }
                  }

                  if (showDenuvoPill) {
                    const pill = document.createElement("span");
                    pill.className = "gamegen-pill orange";
      ...
      if (!logState.missingOnce) {
        backendLog("GameGen: steamdbContainer not found on this page");
  ...
  function onFrontendReady() {
            ...
            if (window.location.hostname === "store.steampowered.com") {
              if (
                localStorage.getItem(
                  "GameGen millennium disclaimer accepted",
                ) !== "1"
              ) {
    ...
    setTimeout(function () {
      if (
        ...
        backendLog("[GameGen] Gamepad detected - Navigation enabled");

        // Only show visual hint in Big Picture mode
        if (window.__GameGen_IS_BIG_PICTURE__) {
          const hint = document.createElement("div");
          hint.id = "gamegen-gamepad-hint";
          hint.innerHTML = "🎮 " + tr("bigpicture.mouseTip");
          hint.style.cssText =
            "\
                        position: fixed;\
                        bottom: 20px;\
          ...
          if (!document.querySelector("#gamegen-gamepad-hint-styles")) {
            const style = document.createElement("style");
            style.id = "gamegen-gamepad-hint-styles";
            style.textContent =
              "\
                            @keyframes fadeInOut {\
    ...
    try {
      if (
        ...
        Millennium.callServerMethod("gamegen", "GetInitApisMessage", {
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
        ...
        try {
          if (window.location.hostname === "store.steampowered.com") {
            if (!sessionStorage.getItem("GameGenLoadedAppsGate")) {
              sessionStorage.setItem("GameGenLoadedAppsGate", "1");
              Millennium.callServerMethod("gamegen", "ReadLoadedApps", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
  ...
  document.addEventListener(
    ...
    function (evt) {
      ...
      const anchor = evt.target.closest(".gamegen-button");
      if (anchor) {
        evt.preventDefault();
        evt.stopPropagation(); // Stop propagation to avoid conflicts
        backendLog("GameGen delegated click");
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            if (runState.inProgress && runState.appid === appid) {
              backendLog(
                "GameGen: operation already in progress for this appid",
              );
              return;
            }
            ...
            const continueWithAdd = function () {
              ...
              const status = overlay
                ? overlay.querySelector(".gamegen-status")
                : null;
              const apiList = overlay
                ? overlay.querySelector(".gamegen-api-list")
                : null;

              if (status)
                status.textContent = tr("Searching across sources...");

              Millennium.callServerMethod("gamegen", "CheckApisForApp", {
                appid,
                contentScriptQuery: "",
              })
                .then(function (res) {
                  try {
                    ...
                    if (available.length === 0) {
                      const msg = tr("Game not found on any available API.");
                      if (status) status.textContent = msg;
                      const hideBtn = overlay
                        ? overlay.querySelector(".gamegen-hide-btn")
                        : null;
                      if (hideBtn)
                        hideBtn.innerHTML = "<span>" + tr("Close") + "</span>";
                      return;
                    }
                    ...
                    try {
                      if (
                        ...
                        if (
                          typeof window.__GameGenSettings.values.general
                    ...
                    backendLog("GameGen: CheckApisForApp error: " + err);
                    if (status)
                      status.textContent = tr("Error: {error}").replace(
                        "{error}",
                        err.message,
                      );
                  }
                ...
                .catch(function (err) {
                  backendLog("GameGen: CheckApisForApp promise error: " + err);
                });
            };
              ...
              if (apiName && apiName.toLowerCase().includes("morrenus")) {
                ...
                try {
                  if (
                    window.__GameGenSettings &&
                    window.__GameGenSettings.values &&
                    window.__GameGenSettings.values.advanced
                  ) {
                    morrenusKey =
                      window.__GameGenSettings.values.advanced
                        .morrenusApiKey || "";
                  ...
                  if (!morrenusKey) {
                    for (const group in window.__GameGenSettings.values) {
                      if (
                        window.__GameGenSettings.values[group] &&
                        window.__GameGenSettings.values[group].morrenusApiKey
                      ) {
                        morrenusKey =
                          window.__GameGenSettings.values[group]
                            .morrenusApiKey;
                ...
                if (morrenusKey && /^smm_[0-9a-f]{96}$/.test(morrenusKey)) {
                  ...
                  if (overlay) {
                    const status = overlay.querySelector(".gamegen-status");
                    if (status)
                      status.textContent = tr("Verifying API limits...");
                    const cancelBtn = overlay.querySelector(
                      ".gamegen-cancel-btn",
                    );
                    if (cancelBtn) cancelBtn.style.display = "none";
                  ...
                  Millennium.callServerMethod("gamegen", "GetMorrenusStats", {
                    ...
                    .catch((e) => {
                      backendLog(
                        "GameGen: Error checking Morrenus API limit: " + e,
                      );
            ...
            function showSourceSelectionModal(appid, available) {
              ...
              const colors = getThemeColors();
              const title = overlay.querySelector(".gamegen-title");
              const status = overlay.querySelector(".gamegen-status");
              const apiList = overlay.querySelector(".gamegen-api-list");

              if (title) title.textContent = tr("Select Download Source");
              ...
              if (apiList) {
                ...
                available.forEach((source) => {
                  const btn = document.createElement("a");
                  btn.href = "#";
                  btn.className = "gamegen-btn focusable";
  ...
  function startPolling(appid) {
    ...
    const timer = setInterval(() => {
      ...
      try {
        Millennium.callServerMethod("gamegen", "GetAddViaGameGenStatus", {
          appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            ...
            const overlay = document.querySelector(".gamegen-overlay");
            const title = overlay
              ? overlay.querySelector(".gamegen-title")
              : null;
            const status = overlay
              ? overlay.querySelector(".gamegen-status")
              : null;
            const wrap = overlay
              ? overlay.querySelector(".gamegen-progress-wrap")
              : null;
            const progressInfo = overlay
              ? overlay.querySelector(".gamegen-progress-info")
              : null;
            const percent = overlay
              ? overlay.querySelector(".gamegen-percent")
              : null;
            const downloadSize = overlay
              ? overlay.querySelector(".gamegen-download-size")
              : null;
            const bar = overlay
              ? overlay.querySelector(".gamegen-progress-bar")
              : null;

            // Update individual API status in the list
            if (overlay) {
              const colors = getThemeColors();
              const apiItems = overlay.querySelectorAll(".gamegen-api-item");
              ...
              if (
                ...
                apiItems.forEach((item) => {
                  ...
                  const apiStatus = item.querySelector(".gamegen-api-status");
                  if (!apiStatus) return;
                  ...
                  if (apiName === successfulApi) {
                    ...
                    apiStatus.innerHTML = `<span style="color:${colors.accent};">${tr("Found")}</span><i class="fa-solid fa-check" style="color:${colors.accent};"></i>`;
                    ...
                    if (st.apiErrors && st.apiErrors[apiName]) {
                      ...
                      if (apiError.type === "timeout") {
                        apiStatus.innerHTML = `<span style="color:#ff5c5c;">${tr("Error, Timed Out")}</span><i class="fa-solid fa-clock" style="color:#ff5c5c;"></i>`;
                      } else if (apiError.type === "error") {
                        const code = apiError.code ? String(apiError.code) : "";
                        apiStatus.innerHTML = `<span style="color:#ff5c5c;">${tr("Error, Code: {code}").replace("{code}", code)}</span><i class="fa-solid fa-exclamation-triangle" style="color:#ff5c5c;"></i>`;
                      }
                    } else {
                      // Mark as not found
                      item.style.background = `rgba(0,0,0,0.2)`;
                      item.style.borderColor = colors.borderRgba;
                      apiStatus.innerHTML = `<span style="color:${colors.textSecondary};">${tr("Not found")}</span><i class="fa-solid fa-xmark" style="color:${colors.textSecondary};"></i>`;
                    }
                  } else {
                    // This API comes after the successful one, mark as skipped
                    item.style.background = `rgba(0,0,0,0.15)`;
                    item.style.borderColor = colors.borderRgba;
                    apiStatus.innerHTML = `<span style="color:${colors.textSecondary};">${tr("Skipped")}</span><i class="fa-solid fa-minus" style="color:${colors.textSecondary};"></i>`;
                  }
                });
              }
              ...
              if (st.status === "checking" && st.currentApi) {
                apiItems.forEach((item) => {
                  ...
                  if (apiName === st.currentApi) {
                    ...
                    item.style.borderColor = colors.accent;
                    apiStatus.innerHTML = `<span style="color:${colors.accent};">${tr("Checking…")}</span><i class="fa-solid fa-spinner" style="color:${colors.accent};animation: spin 1.5s linear infinite;"></i>`;
                  }
                });
            ...
            if (st.status === "checking" && st.currentApi && title) {
              title.textContent = tr("GameGen · {api}").replace(
                "{api}",
                st.currentApi,
              );
            } else if (
              ...
              title.textContent = t("common.appName", "gamegen");
            }
            ...
            if (status) {
              ...
              if (st.status === "checking")
                status.innerHTML =
                  spinner + "<span>" + tr("Checking availability…") + "</span>";
              if (st.status === "downloading")
                status.innerHTML =
                  dlIcon + "<span>" + tr("Downloading…") + "</span>";
              if (st.status === "processing")
                status.innerHTML =
                  gearIcon + "<span>" + tr("Processing package…") + "</span>";
              if (st.status === "installing")
                status.innerHTML =
                  gearIcon + "<span>" + tr("Installing…") + "</span>";
              if (st.status === "checking content")
                status.innerHTML =
                  spinner + "<span>" + tr("Checking content…") + "</span>";
              if (st.status === "failed")
                status.innerHTML =
            ...
            if (
              ...
              const cancelBtn = overlay
                ? overlay.querySelector(".gamegen-cancel-btn")
                : null;
            ...
            if (["checking content", "done"].includes(st.status)) {
              ...
              if (title) title.textContent = t("common.appName", "gamegen");
            ...
            if (st.status === "done") {
              ...
              if (overlay) {
                ...
                if (title) {
                  ...
                  checkText.textContent = tr("Game Added!");
                ...
                if (status) {
                  ...
                  if (!result) {
                    ...
                    const status_content = [
                      tr("Content details =>"),
                      `\u00A0\u00A0• ${tr("Workshop: ")}${tr(result.workshop)}`,
                    ];
                    if (
                      result.dlc.missing.length ||
                      result.dlc.included.length
                    ) {
                      status_content.push(`\u00A0\u00A0• ${tr("Dlc: ")}`);
                      if (result.dlc.included.length > 0) {
                        status_content.push(
                          `\u00A0\u00A0\u00A0\u00A0◦ ${tr("Included")}: ${result.dlc.included.length}`,
                        );
                      }
                      if (result.dlc.missing.length > 0) {
                        const missingLinks = result.dlc.missing
                          .map(
                            (id) =>
                              `<a href="#" class="gg-dlc-link" data-dlc-id="${id}" style="color:#67c1f5;text-decoration:underline;cursor:pointer;">${id}</a>`,
                          )
                          .join(", ");
                        status_content.push(
                          `\u00A0\u00A0\u00A0\u00A0◦ ${tr("Missing")}: ${result.dlc.missing.length} (${missingLinks})`,
                        );
                      }
                    }
                ...
                const hideBtn = overlay.querySelector(".gamegen-hide-btn");
                if (hideBtn) {
                  hideBtn.className = "gamegen-btn primary gamegen-hide-btn";
                  hideBtn.style.cssText =
                    "min-width:140px;display:flex;align-items:center;justify-content:center;text-align:center;";
                  hideBtn.innerHTML =
              ...
              const btnEl = document.querySelector(".gamegen-button");
            ...
            if (st.status === "failed") {
              ...
              if (status)
                status.textContent = tr("Failed: {error}").replace(
                  "{error}",
                  st.error || tr("Unknown error"),
                );
  ...
  setTimeout(addGameGenButton, 1000);
  setTimeout(addGameGenButton, 3000);
  ...
  function showLoadedAppsPopup(apps) {
    // Avoid duplicates
    if (document.querySelector(".gamegen-loadedapps-overlay")) return;
    ensureFontAwesome();
    ensureGameGenStyles();
    const overlay = document.createElement("div");
    overlay.style.cssText =
    ...
    overlay.className = "gamegen-loadedapps-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);z-index:99999;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";
    overlay.className = "gamegen-loadedapps-overlay";
    overlay.style.cssText =
    ...
    title.textContent = tr("GameGen · Added Games");
    const body = document.createElement("div");
    ...
    if (apps && apps.length) {
      ...
      body.textContent = tr("No games found.");
    }
    const btnRow = document.createElement("div");
    btnRow.style.cssText =
    ...
    instructionText.textContent = tr(
      "Left click to install, Right click for SteamDB",
    );
    const dismissBtn = document.createElement("a");
    dismissBtn.className = "gamegen-btn";
    dismissBtn.innerHTML = "<span>" + tr("Dismiss") + "</span>";
    dismissBtn.href = "#";
    dismissBtn.onclick = function (e) {
      e.preventDefault();
      try {
        Millennium.callServerMethod("gamegen", "DismissLoadedApps", {
          contentScriptQuery: "",
        });
      } catch (_) { }
      try {
        sessionStorage.setItem("GameGenLoadedAppsShown", "1");
      } catch (_) { }
      overlay.remove();
    };
