...
SETTINGS_GROUPS: List[SettingGroup] = [
    SettingGroup(
        key="general",
        label="General",
        description="Global GameGen preferences.",
        options=[
            SettingOption(
                key="useSteamLanguage",
                label="Use Steam Language",
                option_type="toggle",
                description="Use the Steam client's language for GameGen.",
                default=True,
            ...
            SettingOption(
                ...
                label="Language",
                option_type="select",
                description="Choose the language used by GameGen.",
                default="en",
            ...
            SettingOption(
                ...
                label="Donate Keys",
                option_type="toggle",
                description="Allow GameGen to donate spare Steam keys. (placeholder option)",
                default=True,
                metadata={"yesLabel": "Yes", "noLabel": "No"},
            ),
            SettingOption(
                ...
                label="Theme",
                option_type="select",
                description="Choose the color theme for GameGen interface.",
                default="original",
